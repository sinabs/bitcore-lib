...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  console.log(reader.buf.slice(reader.pos,reader.buf.length).toString('hex'));
  this.version = reader.readInt32LE();
  console.log('version:'+ this.version);
  if(this.version == 20){
      reader.readUInt32LE();
  }
  console.log('sizeTxIns buf:'+reader.buf.slice(reader.pos,reader.buf.length).toString('hex'));
  ...
  console.log('sizeTxIns hasWitnesses buf:'+reader.buf.slice(reader.pos,reader.buf.length).toString('hex'));
